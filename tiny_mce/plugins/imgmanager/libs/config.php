...
//!!!! CHANGE THIS !!!!!!
// WEB BASE DIRECTORY
defined('WEB_BASE') || define('WEB_BASE', 'tiny_mce/images' );


//!!!! CHANGE THIS !!!!!!
//UPLOAD PATH
defined('UPLOADS_PATH')
        || define('UPLOADS_PATH', realpath(dirname(__FILE__) . DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'karmora.com/'.WEB_BASE ));


defined('UPLOADS_URL') || define('UPLOADS_URL', 'https://'.$_SERVER['HTTP_HOST'].'/'.WEB_BASE );
