...
var Core = function() {
    ...
    var runPrepJS = function() {
        ...
        $(window).load(function() {
            ...
            var scripts = {
                // HIGH PRIORITY
                gmap: 'admin/public/admin/vendor/plugins/map/gmaps.min.js',
                jquerymap: 'public/admin/vendor/plugins/gmap/jquery.ui.map.js',
                mixitup: 'public/admin/vendor/plugins/mixitup/jquery.mixitup.min.js',
                mpopup: 'public/admin/vendor/plugins/mfpopup/dist/jquery.magnific-popup.min.js',
                chosen: 'public/admin/vendor/plugins/chosen/chosen.jquery.min.js',
                moment: 'public/admin/vendor/plugins/daterange/moment.min.js',
                globalize: 'public/admin/vendor/plugins/globalize/globalize.js',
                // FORM PICKERS
                cpicker: 'public/admin/vendor/plugins/colorpicker/bootstrap-colorpicker.js',
                timepicker: 'public/admin/vendor/plugins/timepicker/bootstrap-timepicker.min.js',
                datepicker: 'public/admin/vendor/plugins/datepicker/bootstrap-datepicker.js',
                daterange: 'public/admin/vendor/plugins/daterange/daterangepicker.js',
                // FORMS
                validate: 'public/admin/vendor/plugins/validate/jquery.validate.js',
                masked: 'public/admin/vendor/plugins/jquerymask/jquery.maskedinput.min.js',
                // FORMS TOOLS
                holder: 'public/admin/vendor/bootstrap/holder.js',
                tagmanager: 'public/admin/vendor/plugins/tags/tagmanager.js',
                gritter: 'public/admin/vendor/plugins/gritter/js/jquery.gritter.min.js',
                ladda: 'public/admin/vendor/plugins/ladda/ladda.min.js',
                switcher: 'public/admin/vendor/plugins/formswitch/js/bootstrap-switch.min.js',
                paginator: 'public/admin/vendor/bootstrap/paginator/src/bootstrap-paginator.js',
                knob: 'public/admin/vendor/plugins/jquerydial/jquery.knob.js',
                rangeslider: 'public/admin/vendor/plugins/rangeslider/jQAllRangeSliders.min.js',
                // MED PRIORITY - Large File sizes
                charts: 'public/admin/js/charts.js',
                ckeditorCDN: 'https://cdnjs.cloudflare.com/ajax/libs/ckeditor/4.0.1/ckeditor.js',
                xedit: 'public/admin/vendor/editors/xeditable/js/bootstrap-editable.js',
                summernote: 'public/admin/vendor/editors/summernote/summernote.js',
                elfinder: 'public/admin/vendor/plugins/elfinder/js/elfinder.min.js',
                countdown: 'public/admin/vendor/plugins/countdown/jquery.countdown.js',
                jcrop: 'public/admin/vendor/plugins/imagecrop/js/jquery.Jcrop.min.js',
                imagezoom: 'public/admin/vendor/plugins/imagezoom/jquery.elevatezoom.min.js',
                sketchpad: 'public/admin/vendor/plugins/notepad/wPaint.min.js',
                scrollto: 'public/admin/vendor/plugins/scrollto/jquery.scrollTo-1.4.3.1-min.js',
                fileupload: 'public/admin/vendor/bootstrap/fileupload/fileupload.js',
                fitvids: 'public/admin/vendor/plugins/fitvids/jquery.fitvids.js',
                // LARGE IMAGES
