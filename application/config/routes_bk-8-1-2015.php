...
$route['admin/mangewinit/edit/(:any)'] = "admin/mangewinit/edit/$1";
...
// manage sales
$route['admin/managesales'] = "admin/managesales/index";
$route['admin/managesales/index'] = "admin/managesales/index";
$route['admin/managesales/getsales'] = "admin/managesales/getsales";
$route['admin/managesales/sale-detail/(:any)'] = "admin/managesales/getsaleDetail/$1";
$route['admin/managesales/downloadcsv'] = "admin/managesales/downloadcsv";
$route['admin/managesales/downloadData'] = "admin/managesales/downloadData";

// process email queue
$route['admin/process_email_queue/(:any)'] = "admin/process_email_queue/$1";

// Create Manual email queue
$route['admin/custom_email_queue/(:any)'] = "admin/manualemailqueue/$1";
...
$route['campaign/previewEmails/(:any)'] = "compaign/previewEmails/$1";
$route['(:any)/campaign/previewEmails/(:any)'] = "compaign/previewEmails/$2/$1";
//$route['admin/smokingdeal/Albumstatus/(:any)/(:any)/(:any)/(:any)'] = "admin/smokingdeal/Albumstatus/$1/$2/$3/$4";
$route['(:any)/campaign/previewEmails/(:any)/(:any)'] = "compaign/previewEmailsBasic/$1/$4/5";
//$route['(:any)/previewEmails/(:any)/(:any)'] = "compaign/previewEmails/$1/$3/$2";
...
$route['(:any)/campaign/ambassadorPerview'] = "compaign/ambassadorPerview/$1";


$route['campaign/shopperPerview'] = "compaign/shopperPerview";
$route['(:any)/campaign/shopperPerview'] = "compaign/shopperPerview/$1";

$route['campaign/basicAmbassadorPerview'] = "compaign/basicAmbassadorPerview";
$route['(:any)/campaign/basicAmbassadorPerview'] = "compaign/basicAmbassadorPerview/$1";

$route['campaign/shopper2Shopper'] = "compaign/shopper2Shopper";
$route['(:any)/campaign/shopper2Shopper'] = "compaign/shopper2Shopper/$1";

$route['(:any)/campaign/closed/(:any)'] = "compaign/closed/$1/$2";
$route['(:any)/campaign/history'] = "compaign/histroy/$1";

$route['campaign'] = "compaign/index";
$route['(:any)/campaign'] = "compaign/index/$1";
$route['(:any)/campaign/(:any)'] = "compaign/index/$1/$2";
$route['(:any)/campaign-success'] = "compaign/success/$1";
...
$route['signup/ajexPagination/(:any)/(:any)/(:any)'] = "signup/ajexPagination/$1/$2/$3";
$route['(:any)/signup/ajexPagination/(:any)/(:any)/(:any)'] = "signup/ajexPagination/$2/$3/$4/$1";
$route['signup/hideModal'] = "signup/hideModal";
...
$route['kevin-rules'] = "pages/index/kevin-rules";
$route['(:any)/kevin-rules'] = "pages/index/kevin-rules/$1";

$route['treasure-hunt---ridiculous-funny-rules-'] = "pages/index/treasure-hunt---ridiculous-funny-rules-";
$route['(:any)/treasure-hunt---ridiculous-funny-rules-'] = "pages/index/treasure-hunt---ridiculous-funny-rules-/$1";

$route['fund-shopping-with-karmora'] = "pages/index/fund-shopping-with-karmora";
$route['(:any)/fund-shopping-with-karmora'] = "pages/index/fund-shopping-with-karmora/$1";
...
// routes for forums
$route['FAQ'] = "forum/index/1/7";
$route['(:any)/FAQ'] = "forum/index/1/7/$1";
$route['FAQ/add'] = "forum/add";
$route['(:any)/FAQ/add'] = "forum/add/$1";
$route['FAQ/topic/(:any)'] = "forum/topic/$1";
$route['(:any)/FAQ/topic/(:any)'] = "forum/topic/$2/$1";
$route['(:any)/FAQ/detail/(:any)'] = "forum/detail/$2/$1";
$route['FAQ/detail/(:any)'] = "forum/detail/$1";
$route['FAQ/index/(:any)/(:any)'] = "forum/index/$1/$2";
$route['(:any)/FAQ/index/(:any)/(:any)'] = "forum/index/$2/$3/$1";

$route['FAQ/karmorafaq/(:any)'] = "forum/karmorafaq/$1/1/10";
$route['(:any)/FAQ/karmorafaq/(:any)/(:any)/(:any)'] = "forum/karmorafaq/$2/$3/$4/$1";
$route['(:any)/FAQ/karmorafaq/(:any)'] = "forum/karmorafaq/$2/1/10/$1";
$route['FAQ/karmorafaq/(:any)/(:any)/(:any)'] = "forum/karmorafaq/$1/$2/$3";
...
$route['Pay4MyPurchase/submit'] = "paymypurchase/share";

$route['(:any)/Pay4MyPurchase/submit'] = "paymypurchase/share/$1";
...
$route['(:any)/Pay4MyPurchase/karmora_likes/(:any)'] = "paymypurchase/karmora_likes/$2/$1";
$route['Pay4MyPurchase/karmora_likes/(:any)'] = "paymypurchase/karmora_likes/$1";
...
$route['(:any)/Pay4MyPurchase/automated_email/(:any)'] = "paymypurchase/automated_email/$2/$1";
$route['(:any)/Pay4MyPurchase/automated_email_delate'] = "paymypurchase/automated_email_delate/$1";
$route['Pay4MyPurchase/automated_email_cron'] = "paymypurchase/automated_email_cron";
...
$route['WhereIsKarmoraKevin/submit'] = "whereiskevin/share";
$route['(:any)/WhereIsKarmoraKevin/submit'] = "whereiskevin/share/$1";
$route['(:any)/WhereIsKarmoraKevin/vote'] = "whereiskevin/vote/$1";
$route['(:any)/WhereIsKarmoraKevin/karmora_likes/(:any)'] = "whereiskevin/karmora_likes/$2/$1";
$route['WhereIsKarmoraKevin/karmora_likes/(:any)'] = "whereiskevin/karmora_likes/$1";
...
$route['(:any)/WhereIsKarmoraKevin/automated_email/(:any)'] = "whereiskevin/automated_email/$2/$1";
$route['(:any)/WhereIsKarmoraKevin/automated_email_delate'] = "whereiskevin/automated_email_delate/$1";
$route['WhereIsKarmoraKevin/automated_email_cron'] = "whereiskevin/automated_email_cron";
...
$route['(:any)/share/preview/(:any)'] = "share/preview/$1/$2";
$route['share/unsubscribe'] = "share/unscribe";
$route['(:any)/share/unsubscribe'] = "share/unscribe/$1";
...
$route['(:any)/share/automated/(:any)'] = "share/automated/$2/$1";
$route['share/automated/(:any)'] = "share/automated/$1";
$route['(:any)/share/preview/(:any)'] = "share/preview/$1/$2";
$route['(:any)/share/automated_email/(:any)'] = "share/automated_email/$2/$1";
$route['share/automated_email/(:any)'] = "share/automated_email/$1";
$route['(:any)/share/automated_email_delate'] = "share/automated_email_delate/$1";
$route['share/automated_email_delate'] = "share/automated_email_delate";
$route['share/automated_email_cron'] = "share/automated_email_cron";
...
$route['(:any)/fund-shopping'] = "contactus/fundShopping/$1";
$route['(:any)/PrintDoc'] = "contactus/PrintDoc/$1";

// routes for web store owner benifits // redirecting webstore owner page to contact us controller
$route['web-store-owner-benefits'] = "contactus/webstoreOwnerBenifits";
$route['(:any)/web-store-owner-benefits'] = "contactus/webstoreOwnerBenifits/$1";

// routes for fundraising-with-karmora page
$route['fundraising-with-karmora'] = "pages/index/fundraising-with-karmora";
$route['(:any)/fundraising-with-karmora'] = "pages/index/fundraising-with-karmora/$1";
...
$route['(:any)/gift-it'] = 'gifttoday/giftit/$1';
...
// routes for earn five
$route['earn-five'] = 'earn/index';
$route['(:any)/earn-five'] = 'earn/index/$1';
