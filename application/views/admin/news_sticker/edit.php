...
<section id="content">
    <div id="topbar">
        <ol class="breadcrumb">
            ...
            <li class="active">Edit News Sticker</li>
        </ol>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="panel">
                    <div class="panel-heading">
                        <div class="panel-title"> <i class="fa fa-pencil"></i> Edit News Sticker </div>
                    </div>
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" action="<?php echo base_url('admin/news_sticker/save/'.$ne_id); ?>" method="post">
						...
						<div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-lg-4">  <input id="" name="title" value="<?php echo isset($title) ? $title : set_value('title'); ?>" type="text" class="form-control" placeholder="Title" required="" />
