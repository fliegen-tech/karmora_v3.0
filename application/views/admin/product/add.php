                       ...
                       <?php if(isset($successmessage)) {?><div class="alert alert-info"><?php echo $successmessage ;?></div><?php } ?>
                        <form class="form-horizontal" id="signupForm" method="post" enctype= "multipart/form-data"  >
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <select class="form-control" multiple="multiple" name="parent_cat[]">
                                        <?php
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-4"> 
                                    <input type="checkbox" name="product_is_fetured" value="1">
                           ...
                           <div class="form-group">
                                ...
                                <div class="col-lg-4"> 
                                    <textarea name="product_detail" required="required"> </textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-4"> 
                                    <textarea name="product_how_to_use"> </textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-4"> 
                                    <textarea name="product_ingredients"> </textarea>
                                </div>
                            </div>
